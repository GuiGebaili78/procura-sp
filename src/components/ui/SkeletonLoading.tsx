...
// Componente específico para skeleton de coleta de lixo
export function ColetaLixoSkeletonLoading() {
  return (
    <div className="bg-white rounded-xl shadow-md border border-gray-100">
      <div className="p-6">
        {/* Cabeçalho skeleton */}
...
// Componente específico para skeleton de saúde
export function SaudeSkeletonLoading() {
  return (
    <div className="space-y-4">
      {/* Filtros skeleton */}
